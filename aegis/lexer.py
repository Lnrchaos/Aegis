...
# Note: Security function keywords (encrypt, decrypt, hash, etc.) are now treated as identifiers
# so they can be called as functions
RESERVED_KEYWORDS: Set[str] = {
    "override", "tunnel", "keylogger", "activate", "deactivate", "analyze", "contain", "payload",
